...
var SearchBar = /*#__PURE__*/ _react['default'].forwardRef(function (
  _ref,
  ref
) {
  ...
  var handleBlur = _react['default'].useCallback(
    function (e) {
      setValue(function (v) {
        return v.trim()
      })
  ...
  var handleInput = _react['default'].useCallback(
    function (e) {
  ...
  var handleCancel = _react['default'].useCallback(
    function () {
      setValue('')
  ...
  var handleRequestSearch = _react['default'].useCallback(
    function () {
      if (onRequestSearch) {
  ...
  var handleKeyUp = _react['default'].useCallback(
    function (e) {
    ...
    /*#__PURE__*/ _react['default'].createElement(
      _IconButton['default'],
      {
        ...
        className: (0, _classnames['default'])(
          ...
          _defineProperty({}, classes.iconButtonHidden, value !== '')
        ),
        disabled: disabled,
      },
...
SearchBar.defaultProps = {
  ...
  disabled: false,
  placeholder: 'Search',
  searchIcon: /*#__PURE__*/ _react['default'].createElement(
    _Search['default'],
    null
  ),
  style: null,
