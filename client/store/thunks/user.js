...
import { getUser, putUser, putUserPassword, putRestaurantInfo } from '_api/user';
...
export const attemptUpdatePassword = passwordInfo => dispatch =>
  putUserPassword(passwordInfo)
    ...
    export const attemptUpdateRestaurantInfo = updatedRestaurant => dispatch =>
    putRestaurantInfo(updatedRestaurant)
